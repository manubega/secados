...
<!-- FORMULARIO PARA INGRESAR NUEVA ORDEN DE PRODUCCIÒN -->
	...
	<br>
	<br>
	<input type="text" name="numOrden" id="tres"  value ="numOrden" required=""><span class="error">*</span>
	<br>
	<br>
	<input type="text" name="clienteOrden" id = "uno" value ="nombre" required=""><span class="error">*</span>
	<br>
	<br>
	<input type="number" name="cantidadOrden" id = "cantidadOrden" value="cantidad" " required=""><span class="error">*</span>
	
	<input type="text" name="colorOrden" id="colorOrden"  value="color" required=""><span class = "error">*<label for="error"></label></span>
	<br>
	<br>
	CATEGORIA:
